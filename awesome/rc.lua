...
screen.connect_signal("request::desktop_decoration", function(s)
	...
	local battery_widget = battery.new()
	-----------------------------------------------------------------------------
	-- Bar
	-----------------------------------------------------------------------------
...
awful.keyboard.append_global_keybindings({
	...
	-- Alt+Tab to cycle forward through open applications
	awful.key({ "Mod1" }, "Tab",
		function()
			awful.client.focus.byidx(1) -- Switch to the next client
		end,
		{ description = "switch to next application", group = "client" }),

	-- Shift+Alt+Tab to cycle backward
	awful.key({ "Mod1", "Shift" }, "Tab",
		function()
			awful.client.focus.byidx(-1) -- Switch to the previous client
		end,
		{ description = "switch to previous application", group = "client" }),
